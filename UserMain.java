...
public class UserMain extends javax.swing.JFrame {
	...
	{//GEN-FIRST:event_jMenuItem2ActionPerformed 
		...
		if(rs.next())
        new DownloadFile(rs.getString(5).toLowerCase(),user).setVisible(true);
		else
	...
	private void jMenuItem5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem4ActionPerformed
        // TODO add your handling code here:
		new KeyUpdate(user).setVisible(true);
    }
